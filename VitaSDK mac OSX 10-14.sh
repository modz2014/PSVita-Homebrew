...
var=" #### Here we are going to edit your .bashrc file ####"
printf "%s\n" "$var"

cp /etc/bashrc /Users/modz2014/Desktop/bashrc.bak

echo 'export VITASDK=/usr/local/vitasdk' >> /etc/bashrc
echo 'export PATH=$VITASDK/bin:$PATH' >> /etc/bashrc
